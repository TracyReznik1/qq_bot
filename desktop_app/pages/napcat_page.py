...
class NapCatPage(QWidget):
    ...
    def __init__(self, settings_service, napcat_service, webui_service, qq_login_service, parent=None):
        ...
        self.btn_login = QPushButton("扫码登录 QQ")
        self.btn_login.clicked.connect(self.login_qq)
        ...
        self.napcat_service.state_changed.connect(self.update_status)
        self.load_settings()
    ...
    def login_qq(self):
        ...
        if self.napcat_service.process.state() == QProcess.ProcessState.NotRunning:
            self.start_napcat()
